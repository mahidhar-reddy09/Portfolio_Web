...
const CardComponent = () => {
  return (
    <div className="mt-12 mt-1 md:mt-16 flex flex-col md:flex-row max-w-4xl mx-auto bg-transparent shadow-lg rounded-lg overflow-hidden">
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 w-[15rem] md:w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
      ...
      <div className="relative z-50 flex flex-col items-center px-5 mt-8 md:mt-16 lg:-mt-72 lg:mb-96">
        {children}
      </div>
    </div>
  );
