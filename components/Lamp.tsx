...
const CardComponent = () => {
  return (
    <div className="mt-12 flex flex-col md:flex-row max-w-4xl mx-auto bg-transparent shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="w-full md:w-1/2 p-4">
        ...
        <p className="mt-6 md:mt-24 text-white md:ml-10">
